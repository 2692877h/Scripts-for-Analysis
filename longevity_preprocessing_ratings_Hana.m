...
% set info
subj_id = 'subj33'; % change with the ID of the subj to analyse
group = 'short'; 
task = 'ratings'; 
...
cfg.bpfreq = [1 80];% [high-pass low-pass] in Hz
...
%
% this is just a coarse artifact rejection
% remove only extreme trials/channels/muscle that can interphere with ICA
cfg          = [];
cfg.method   = 'summary';
...
% identify residual big muscle artefacts
cfg = [];
cfg.channel = good_channels;
cfg.layout = 'biosemi128.lay';
cfg.viewmode = 'vertical';
cfg.allowoverlap = 'yes';
artif = ft_databrowser(cfg,artrej_2);
...
cfg = [];
cfg.component = [7]; % components to remove
